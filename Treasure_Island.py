...
if choice1 == "left":
  ...
  if choice2 == "wait":
    ...
    if choice3 == "red":
      ...
      print("Unfortunately you have been eaten by wild beats. Game over.")
    else:
      print("Unlucky, you choose a door that does not exist. Game over.")
  else:
    print("You got attacked by hungry piranha. Game over.")
else:
